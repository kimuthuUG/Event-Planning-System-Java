          ...
          <div class="user-form" style="width: 50%;">
            <form action="EventServlet">
              <div class="form-group">
                ...
                <input name="txtEventName" type="text" class="form-control" id="txtEventName" placeholder="Enter the Event Name" required>
              </div>
              <div class="form-group">
                <label for="txtEventVenue">Venue</label>
                <input name="txtEventVenue" type="text" class="form-control" id="txtEventVenue" placeholder="Enter the Venue" required>
              </div>
              <div class="form-group">
                <label for="dateEventDate">Event Date</label>
                <input name="dateEventDate" type="date" class="form-control" id="dateEventDate" placeholder="Enter the Date" required>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <textarea  name="textDescription" type="date" class="form-control" id="textDescription" placeholder="Enter Description" required></textarea>
              </div>  
              <div class="form-group">
