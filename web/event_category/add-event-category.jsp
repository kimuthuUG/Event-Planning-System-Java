    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Add an Event Category</h2>
          <div class="user-form" style="width: 50%;">
            <form action="EventCategoryServlet">
              <div class="form-group">
                <label for="txtCategoryName">Category Name</label>
                <input name="txtCategoryName" type="text" class="form-control" id="txtCategoryName" placeholder="Enter the Category Name" required>
              </div>
              <div class="form-group">
                <label for="txtCategoryDesc">Description</label>
                <input name="txtCategoryDesc" type="text" class="form-control" id="txtCategoryDesc" placeholder="Enter Category Description" required>
              </div>
