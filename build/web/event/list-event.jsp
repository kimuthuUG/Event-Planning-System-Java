      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <div class="flex" style="display: flex; gap: 24px; align-items: center;">
            ...
            <button type="button" class="btn btn-success" style="max-height: 35px;"><a href="EventServlet?action=add"><i class="fa fa-plus" aria-hidden="true"></i></a></button>
          </div>
              ...
              <tbody>
                <tr>
                  ...
                  <td class="text-center">
                    <a class="btn btn-warning" href="EventServlet?action=edit&id=<%= ev.getEventId()%>">Edit</a>
                    <a class="btn btn-danger" href="EventServlet?action=delete&id=<%= ev.getEventId()%>">Delete</a>
                  </td>
                </tr>
                <%}%>
              </tbody>
